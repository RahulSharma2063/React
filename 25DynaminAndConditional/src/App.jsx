...
function App() {
  ...
  const [cardStyle, setCardStyle] = useState(
    {width:'200px', border:"1px solid #ccc", boxShadow:'1px 1px 1px 1px #bbbbbbae'}
  )
